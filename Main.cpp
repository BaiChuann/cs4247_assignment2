...
void DefineScene2( Scene &scene, int imageWidth, int imageHeight )
{
	...
	// silver.
	scene.material[0].k_d = Color( 0.5f, 0.5f, 0.5f );
	scene.material[0].k_a = Color( 0.2f, 0.2f, 0.2f );
	scene.material[0].k_r = Color( 0.5f, 0.5f, 0.5f );
	scene.material[0].k_rg = Color( 0.5f, 0.5f, 0.5f );
	scene.material[0].n = 50.0f;

	// jade.
	scene.material[1].k_d = Color( 0.54f, 0.89f, 0.07f );
	scene.material[1].k_a = Color( 0.135f, 0.2225f, 0.1575f );
	scene.material[1].k_r = Color( 0.316f, 0.316f, 0.316f );
	scene.material[1].k_rg = Color( 0.316f, 0.316f, 0.316f );
	scene.material[1].n = 12.8f;

	// gold.
	scene.material[2].k_d = Color( 0.751f, 0.606f, 0.22f );
	scene.material[2].k_a = Color( 0.24f, 0.199f, 0.0745f );
	scene.material[2].k_r = Color( 0.628f, 0.555f, 0.336f );
	scene.material[2].k_rg = Color( 0.628f, 0.555f, 0.336f );
	scene.material[2].n = 50.0f;

	// pearl.
	scene.material[3].k_d = Color( 1.0f, 0.829f, 0.829f );
	scene.material[3].k_a = Color( 0.25f, 0.207f, 0.207f );
	scene.material[3].k_r = Color( 0.296f, 0.296f, 0.296f );
	scene.material[3].k_rg = Color( 0.8f, 0.8f, 0.8f ) / 3.0f;
	scene.material[3].n = 112.0f;

	// Copper.
	scene.material[4].k_d = Color( 0.7038f, 0.2704f, 0.08f );
	scene.material[4].k_a = Color( 0.1912f, 0.0735f, 0.0225f );
	scene.material[4].k_r = Color( 0.256f, 0.137f, 0.086f );
	scene.material[4].k_rg = Color( 0.256f, 0.137f, 0.086f );
	scene.material[4].n = 12.8f;
	...
	scene.surfacep[14] = new Triangle( Vector3d( 50.0, 50.0, 40.0 ), Vector3d( 50.0, 30.0, 50.0 ),
										Vector3d( 40.0, 50.0, 50.0 ), &(scene.material[4]) );
